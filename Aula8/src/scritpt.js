...
let frase = 'Eu amo gatos. Gatos são muito bons. Gatos dão uma experiência única.';

frase = frase.replaceAll('Gatos', 'Livros');
frase = frase.replaceAll('gatos','livros');
...
// Utilização dos métodos idexOf(),  lastIndexof() e search()
...
// Utilização do método endWith()
let nome = 'Stephanie Almeida';
let exEndesWith = nome.endsWith('Almeida');

console.log(exEndesWith);
